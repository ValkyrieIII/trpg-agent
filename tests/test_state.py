...
class TestUnknownTrigger:
    ...
    def test_unknown_trigger_returns_none_and_no_change(self):
        ...
        assert sm.get_state() == {"emotion": "calm", "trust": 0.5, "stamina": "fresh"}
...
class TestCombinedTriggers:
    ...
    def test_betrayed_full_effect(self):
        ...
        sm = StateMachine()
        sm.apply("betrayed")
        assert sm.get_state() == {"emotion": "wary", "trust": 0.4, "stamina": "fresh"}
    ...
    def test_helped_full_effect(self):
        ...
        sm.apply("threatened")
        sm.apply("helped")
        assert sm.get_state() == {"emotion": "calm", "trust": 0.6, "stamina": "fresh"}
    ...
    def test_multiple_triggers_accumulate(self):
        ...
        assert sm.get_state() == {"emotion": "calm", "trust": 0.6, "stamina": "tired"}
